-- [[ NAXOR V12.0 - THE FINAL STABLE MERGE ]] --
...
-- [ وظيفة النيون الموحد ] --
local function ApplyNeon(obj, color)
    local s = Instance.new("UIStroke", obj)
    s.Color = color or Color3.fromRGB(55, 55, 55) -- نيون رمادي حاد
    s.Thickness = 1.2
...
ApplyNeon(Main, MainColor).Thickness = 2
...
Separator.Size = UDim2.new(1, 0, 0, 1); Separator.Position = UDim2.new(0, 0, 0, 65); Separator.BackgroundColor3 = Color3.fromRGB(45, 45, 45); Separator.BorderSizePixel = 0; Separator.ZIndex = 12
...
-- [[ محتوى صفحة HOME ]] --
local IDCard = Instance.new("Frame", P.Home); IDCard.Size = UDim2.new(0, 210, 0, 210); IDCard.Position = UDim2.new(0, 25, 0, 25); IDCard.BackgroundColor3 = Color3.fromRGB(12, 12, 12); Instance.new("UICorner", IDCard).CornerRadius = UDim.new(0, 10); ApplyNeon(IDCard)
...
-- النقطة الخضراء
local Dot = Instance.new("Frame", IDCard); Dot.Size = UDim2.new(0, 7, 0, 7); Dot.Position = UDim2.new(0, 15, 0, 81); Dot.BackgroundColor3 = Color3.fromRGB(0, 255, 100); Instance.new("UICorner", Dot).CornerRadius = UDim.new(1, 0); ApplyNeon(Dot, Color3.fromRGB(0, 255, 100))
...
local RankTag = Instance.new("Frame", IDCard); RankTag.Size = UDim2.new(0, 60, 0, 16); RankTag.Position = UDim2.new(0, 85, 0, 42); RankTag.BackgroundColor3 = Color3.fromRGB(20, 20, 20); Instance.new("UICorner", RankTag).CornerRadius = UDim.new(0, 4); ApplyNeon(RankTag, MainColor)
...
-- [ الأزرار السفلية ومربع الصورة (النيون الموحد) ] --
local function CreateStyledBtn(name, pos, size, parent)
    local btn = Instance.new("TextButton", parent); btn.Size = size; btn.Position = pos; btn.BackgroundColor3 = Color3.fromRGB(15, 15, 15); btn.Text = name; btn.TextColor3 = Color3.new(1, 1, 1); btn.Font = "GothamBold"; btn.TextSize = 10; Instance.new("UICorner", btn).CornerRadius = UDim.new(0, 8)
    ApplyNeon(btn)
    return btn
end
...
local PicBox = Instance.new("Frame", P.Home); PicBox.Size = UDim2.new(1, -275, 0, 210); PicBox.Position = UDim2.new(0, 250, 0, 25); PicBox.BackgroundColor3 = Color3.fromRGB(12, 12, 12); Instance.new("UICorner", PicBox).CornerRadius = UDim.new(0, 10); ApplyNeon(PicBox)
