-- [[ NAXOR V7.0 - THE DEFINITIVE EDITION ]] --
...
local P = {
    ...
    Pages = Instance.new("Frame", PagesCont),
...
local function CreateNavBtn(name, x, target)
    ...
    b.BackgroundTransparency = 1; b.Text = name; b.TextColor3 = Color3.fromRGB(180, 180, 180)
    b.Font = "GothamMedium"; b.TextSize = 12; b.ZIndex = 15
...
-- [[ الأزرار السفلية الملونة والواضحة ]] --
