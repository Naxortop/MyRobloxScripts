-- [[ NAXOR V8.5 - FINAL STABLE VERSION ]] --
...
-- [ وظيفة السحب ومنع تحرك الكاميرا ] --
...
local function CreateInfoLabel(txt, y)
    local l = Instance.new("TextLabel", IDCard); l.Text = txt; l.Size = UDim2.new(1, -30, 0, 20); l.Position = UDim2.new(0, 15, 0, y); l.BackgroundTransparency = 1; l.TextColor3 = Color3.fromRGB(200, 200, 200); l.TextSize = 9; l.Font = "GothamMedium"; l.TextXAlignment = "Left"
    return l
end

local DeviceType = (UIS.TouchEnabled and not UIS.KeyboardEnabled) and "Mobile" or (UIS.GamepadEnabled and "Console" or "PC")
CreateInfoLabel("Device: " .. DeviceType, 90)
CreateInfoLabel("Account Age: " .. LP.AccountAge .. " Days", 110)
CreateInfoLabel("User ID: " .. LP.UserId, 130)
local PlayTimeLabel = CreateInfoLabel("PlayTime: 00:00:00", 150); PlayTimeLabel.TextColor3 = MainColor; PlayTimeLabel.Font = "GothamBold"
