-- [[ NAXOR OFFICIAL V48.0 - FULL STABLE VERSION ]] --
...
-- دالة السحب (تمنع تحريك الكاميرا أثناء السحب)
function Utils:MakeDraggable(Frame, Handle)
    ...
    Handle.InputBegan:Connect(function(input)
        if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
            ...
            CAS:BindAction("BlockDragCamera", function()
...
ToggleBtn.MouseButton1Click:Connect(function()
    PlayClickSound(); Main.Visible = true; ToggleBtn.Visible = false
end)
...
-- [ المربع اليمين وعداد المستخدمين ] --
...
local OnlineLabel = Instance.new("TextLabel", BigBox); OnlineLabel.Size = UDim2.new(0, 150, 0, 20); OnlineLabel.Position = UDim2.new(0, 15, 0, 10); OnlineLabel.BackgroundTransparency = 1; OnlineLabel.TextColor3 = Theme.Green; OnlineLabel.Font = "GothamBold"; OnlineLabel.TextSize = 10; OnlineLabel.TextXAlignment = "Left"

task.spawn(function()
    while true do
        OnlineLabel.Text = "🟢 Online Users: " .. #Players:GetPlayers()
        task.wait(4)
    end
end)
