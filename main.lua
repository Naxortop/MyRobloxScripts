-- [[ NAXOR V19.0 - TOP CENTER TOGGLE & FULL VERIFIED ]] --
...
-- [[ 1. الزر العائم - الموقع الجديد: منتصف الأعلى ]] --
local ToggleBtn = Instance.new("ImageButton", Screen)
ToggleBtn.Name = "NaxorToggle"
ToggleBtn.Size = UDim2.new(0, 50, 0, 50)
ToggleBtn.Position = UDim2.new(0.5, -25, 0, 15) -- منتصف (0.5) فوق (15 بكسل من الحافة)
ToggleBtn.BackgroundColor3 = Color3.fromRGB(10, 10, 10)
ToggleBtn.Image = "rbxassetid://18443200213"
ToggleBtn.Visible = false
Instance.new("UICorner", ToggleBtn).CornerRadius = UDim.new(1, 0)
Utils:ApplyNeon(ToggleBtn, Theme.Accent)
...
-- 3. الهيدر (العنوان + النافيجيشن + الإغلاق)
local Header = Instance.new("Frame", Main); Header.Size = UDim2.new(1, 0, 0, 65); Header.BackgroundTransparency = 1; Header.ZIndex = 100
Utils:MakeDraggable(Main, Header)

local Logo = Instance.new("TextLabel", Header); Logo.RichText = true; Logo.Text = "N.X.R <font color='#DCDCDC'>>>> </font>"
Logo.Size = UDim2.new(0, 150, 1, 0); Logo.Position = UDim2.new(0, 25, 0, 0); Logo.BackgroundTransparency = 1; Logo.TextColor3 = Theme.Accent; Logo.TextSize = 22; Logo.Font = "GothamBold"; Logo.TextXAlignment = "Left"

local CloseBtn = Instance.new("TextButton", Header); CloseBtn.Size = UDim2.new(0, 30, 0, 30); CloseBtn.Position = UDim2.new(1, -45, 0, 17)
CloseBtn.BackgroundTransparency = 1; CloseBtn.Text = "X"; CloseBtn.TextColor3 = Theme.Accent; CloseBtn.TextSize = 20; CloseBtn.Font = "GothamBold"; CloseBtn.ZIndex = 110
...
local DName = Instance.new("TextLabel", IDCard); DName.Text = LP.DisplayName; DName.Position = UDim2.new(0, 90, 0, 20); DName.Size = UDim2.new(0, 120, 0, 20); DName.TextColor3 = Theme.Text; DName.Font = "GothamBold"; DName.TextSize = 14; DName.BackgroundTransparency = 1; DName.TextXAlignment = "Left"

-- الرتبة
local Rank = Instance.new("Frame", IDCard); Rank.Size = UDim2.new(0, 65, 0, 18); Rank.Position = UDim2.new(0, 90, 0, 45); Rank.BackgroundColor3 = Color3.fromRGB(20, 20, 20); Instance.new("UICorner", Rank).CornerRadius = UDim.new(0, 4); Utils:ApplyNeon(Rank, Theme.Accent)
local RT = Instance.new("TextLabel", Rank); RT.Size = UDim2.new(1, 0, 1, 0); RT.Text = "OWNER"; RT.TextColor3 = Theme.Accent; RT.Font = "GothamBold"; RT.TextSize = 9; RT.BackgroundTransparency = 1
...
local function AddInfo(t, y, isPlaytime)
    ...
    if isPlaytime then l.TextColor3 = Theme.Accent; l.Font = "GothamBold" end
    return l
end
AddInfo("Device: " .. (UIS.TouchEnabled and "Mobile" or "PC"), 85)
AddInfo("Account Age: "..LP.AccountAge.." Days", 100)
local PlayTimeLabel = AddInfo("PlayTime: 00:00:00", 125, true)

-- [[ العداد المزيف (Users) تحت يسار البطاقة ]] --
