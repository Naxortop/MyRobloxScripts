-- [[ NAXOR V9.0 - FULL INTEGRATED SYSTEM ]] --
...
-- تنظيف أي نسخة قديمة لضمان عمل الكود الجديد
...
-- [[ 5. صفحة HOME (البطاقة والمعلومات) ]] --
...
AddInfo("Device: " .. Device, 90)
AddInfo("Account Age: " .. LP.AccountAge .. " Days", 110)
AddInfo("User ID: " .. LP.UserId, 130)
local PlayTimeLabel = AddInfo("PlayTime: 00:00:00", 155, MainColor); PlayTimeLabel.Font = "GothamBold"

-- [[ 6. الأزرار السفلية ومستطيل الإعلانات ]] --
