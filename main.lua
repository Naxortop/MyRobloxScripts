...
local TStroke = Instance.new("UIStroke", ToggleBtn); TStroke.Color = MainColor; TStroke.Thickness = 1
...
local MStroke = Instance.new("UIStroke", Main); MStroke.Color = MainColor; MStroke.Thickness = 1.5
...
-- [[ الخط الفاصل الحقيقي (بدون نيون زائد) ]] --
local Separator = Instance.new("Frame", Main)
Separator.Size = UDim2.new(1, 0, 0, 1); Separator.Position = UDim2.new(0, 0, 0, 65)
Separator.BackgroundColor3 = Color3.fromRGB(40, 40, 40); Separator.BorderSizePixel = 0
...
local IDS = Instance.new("UIStroke", IDCard); IDS.Color = Color3.fromRGB(40, 40, 40); IDS.Thickness = 1
...
-- [ الأزرار السفلية (تم إزالة النيون) ] --
local function CreateStyledBtn(name, pos, size, parent)
    local btn = Instance.new("TextButton", parent); btn.Size = size; btn.Position = pos; btn.BackgroundColor3 = Color3.fromRGB(15, 15, 15); btn.Text = name; btn.TextColor3 = Color3.new(1, 1, 1); btn.Font = "GothamBold"; btn.TextSize = 11; Instance.new("UICorner", btn).CornerRadius = UDim.new(0, 8)
    local s = Instance.new("UIStroke", btn); s.Color = Color3.fromRGB(40, 40, 40); s.Thickness = 1; -- إطار رمادي غامق هادئ
    return btn
end
...
local PicBox = Instance.new("Frame", P.Home); PicBox.Size = UDim2.new(1, -275, 0, 210); PicBox.Position = UDim2.new(0, 250, 0, 25); PicBox.BackgroundColor3 = Color3.fromRGB(12, 12, 12); Instance.new("UICorner", PicBox).CornerRadius = UDim.new(0, 10)
local PS = Instance.new("UIStroke", PicBox); PS.Color = Color3.fromRGB(40, 40, 40); PS.Thickness = 1
